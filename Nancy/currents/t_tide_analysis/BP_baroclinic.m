...
filename = '/ocean/nsoontie/MEOPAR/TidalEllipseData/ModelTimeSeries/BP_currents_20141126_20150426.nc';
%depth index for tidal analysis
depav = 0; %depth average
dlevel = 1; % surface
trun = 0; %truncate water column
d1 = 0; d2 = 0; %depth range
outfile = '/ocean/nsoontie/MEOPAR/TidalEllipseData/BP_region_baroclinic_20141126_20150426';
